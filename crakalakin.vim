...
let s:yellow = "f0c674"
let s:green = "00D876"
let s:lightGreen = "5F9EA0"
let s:aqua = "8abeb7"
let s:darkBlue = "0055ff"
let s:lightBlue = "0080ff"
let s:blue = "81a2be"
"let s:purple = "b294bb"
let s:purple = "786dff"
let s:darkPurple = "d31895"
let s:darkGray = "666666"
let s:gray = "999999"
let s:lightGray = "bbbbbb"
let s:white = "ffffff"
let s:window = "4d5057"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  " OpenGL Hightlighting
  call <SID>X("glType", s:yellow, "", "")
	...
	" Ruby Highlighting
	call <SID>X("rubyConstant", s:gray, "", "")
  call <SID>X("rubyClass", s:darkGray, "", "bold")
  call <SID>X("rubyModule", s:darkGray, "", "bold")
  call <SID>X("rubyModuleDeclaration", s:white, "", "")
  call <SID>X("rubyDefine", s:gray, "", "bold")
  call <SID>X("rubyBlock", s:white, "", "")
  call <SID>X("rubyCurlyBlock", s:white, "", "")
  call <SID>X("rubyCurlyBlockDelimiter", s:white, "", "")
  call <SID>X("rubyDoBlock", s:white, "", "")
	call <SID>X("rubyMethodBlock", s:white, "", "")
  call <SID>X("rubyFunction", s:white, "", "")
	call <SID>X("rubySymbol", s:red, "", "bold")
	call <SID>X("rubyOperator", s:lightBlue, "", "")
	call <SID>X("rubyAccess", s:yellow, "", "")
	call <SID>X("rubyAttribute", s:lightBlue, "", "")
	call <SID>X("rubyInclude", s:lightBlue, "", "")
	call <SID>X("rubyBoolean", s:gray, "", "")
	call <SID>X("rubyInteger", s:blue, "", "")
	call <SID>X("rubyFloat", s:blue, "", "")
  call <SID>X("rubyComment", s:darkGray, "", "")
	call <SID>X("rubyLocalVariableOrMethod", s:white, "", "")
	call <SID>X("rubyInstanceVariable", s:white, "", "")
	call <SID>X("rubyStringDelimiter", s:green, "", "")
	call <SID>X("rubyStringEscape", s:green, "", "")
  call <SID>X("rubyString", s:green, "", "")
	call <SID>X("rubyInterpolationDelimiter", s:white, "", "")
	call <SID>X("rubyInterpolation", s:white, "", "")
	call <SID>X("rubyConditional", s:darkPurple, "", "")
	call <SID>X("rubyConditionalExpression", s:white, "", "")
	call <SID>X("rubyRepeat", s:white, "", "")
	call <SID>X("rubyControl", s:gray, "", "bold")
	call <SID>X("rubyException", s:gray, "", "bold")
  call <SID>X("rubyRegexp", s:pink, "", "")
  call <SID>X("rubyRegexpAnchor", s:pink, "", "")
  call <SID>X("rubyRegexpQuantifier", s:pink, "", "")
  call <SID>X("rubyRegexpParens", s:white, "", "")
  call <SID>X("rubyRegexpEscape", s:green, "", "")
  call <SID>X("rubyRegexpCharClass", s:green, "", "")
  call <SID>X("rubyRegexpDelimiter", s:pink, "", "")

  " Rails Highlighting
  call <SID>X("rubyRailsARValidationMethod", s:gray, "", "")
  call <SID>X("rubyRailsUserClass", s:gray, "", "")
  call <SID>X("rubyRailsARAssociationMethod", s:gray, "", "")
  call <SID>X("rubyRailsARMethod", s:gray, "", "")
  call <SID>X("rubyRailsRenderMethod", s:gray, "", "")
  call <SID>X("rubyRailsMethod", s:gray, "", "")
  call <SID>X("rubyRailsTestMethod", s:gray, "", "bold")
